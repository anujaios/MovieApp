...
//        initilize the window with provided windoscene
        window = UIWindow(windowScene: windowScene)
        self.setLaunchScreenTime()
    }
    
    private func setLaunchScreenTime(){
        //setup and display the launchScreen with delay of 3sec
    ...
    @objc func navigateToMainScreen(){
        ...
        let initialVC = mainVC.instantiateViewController(withIdentifier: "Navigation")
